...
function Promt() {
  ...
  return (
    <div className="flex flex-col items-center justify-between flex-1 w-full px-4 pb-4 md:pb-8">
      {/* ➤ Greeting Section with Big Logo */}
      <div className="mt-8 md:mt-16 text-center flex flex-col items-center gap-4">
        <img
          src={logo}
          alt="NeuroSync Logo"
          className="h-24 w-24 md:h-32 md:w-32 object-contain drop-shadow-[0_0_10px_rgba(0,191,255,0.5)]"
        />
        <h1 className="text-3xl md:text-4xl font-semibold text-white">
          Hi, I'm <span className="text-blue-500">NeuroSync</span>
        </h1>
        <p className="text-gray-400 text-base md:text-sm mt-1">
